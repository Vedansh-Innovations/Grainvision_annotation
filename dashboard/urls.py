...
urlpatterns = [
    ...
    path("reference/mandi/<int:pk>/delete/", views.mandi_delete, name="mandi_delete"),
    ...
    path("reference/commodity/<int:pk>/delete/", views.commodity_delete, name="commodity_delete"),
    path("reference/commodity/<int:pk>/classes/add/", views.commodity_add_class, name="commodity_add_class"),
    path("reference/commodity/<int:pk>/classes/remove/", views.commodity_remove_class, name="commodity_remove_class"),
